...
def main():
    ...
    request = {
        'labelIds': ['UNREAD'],
        'topicName': 'projects/expensetracking-309512/topics/expenseTopic',
        'labelFilterAction': 'INCLUDE'
    }
    x = service.users().watch(userId='me', body=request).execute()
    print(x)
    # x = service.users().stop(userId='me').execute()
    # print(x)
